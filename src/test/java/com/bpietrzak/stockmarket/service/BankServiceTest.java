...
class BankServiceTest {
    ...
    void getBankStateShouldReturnAllStocks() {
        ...
        assertThat(result.stocks().getFirst().quantity()).isEqualTo(10);
        assertThat(result.stocks().getLast().name()).isEqualTo("other");
        assertThat(result.stocks().getLast().quantity()).isEqualTo(5);
    }
    ...
    void setBankStateShouldReplaceExistingStocks() {
        ...
        assertThat(saved.getFirst().getName()).isEqualTo("newstock");
        assertThat(saved.getFirst().getQuantity()).isEqualTo(20);
    }
